...
/**
 * credit: https://github.com/shepeliev/webrtc-kmp/blob/main/src/jsMain/kotlin/com/shepeliev/webrtckmp/externals.kt
 */
...
external class RTCRtpSender {
  ...
  fun setParameters(parameters: RTCRtpSendParameters)
...
external class RTCRtpSendParameters {
  val codes: Array<RTCRtpCodecParameters>
  val headerExtensions: Array<dynamic>
  val rtcp: RTCRtcpParameters
  val transactionId: String
  val encodings: Array<RTCRtpEncodingParameters>
}

external class RTCRtpEncodingParameters {
  var maxBitrate: Int
